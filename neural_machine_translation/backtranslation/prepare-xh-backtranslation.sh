...
echo "Cleaning data..."
python3 prepare_sadilar_monolingual.py $sadilar_dir/sadilar.xh
...
#echo "Cleaning data..."
python3 prepare_c4_monolingual.py $c4_dir/c4/multilingual/c4_dataset.xh


if [ -f $tmp/monolingual.${SUBSAMPLE_SIZE}.${LANG} ]; then
        echo "found monolingual sample, skipping shuffle/sample/tokenize"
else
        cat $sadilar_dir/sadilar.xh.cleaned $c4_dir/c4/multilingual/c4_dataset.xh.cleaned \
