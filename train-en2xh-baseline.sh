# Script for training baseline English to IsiXhosa model. 
...
TEXT=$TRANS/baseline-tokenized.en-xh
fairseq-preprocess --source-lang en --target-lang xh \
        --trainpref $TEXT/train --validpref $TEXT/valid --testpref $TEXT/test \
        --destdir data-bin-en2xh/baseline-tokenized.en-xh \
        --workers 20

# Train translation model over data
CHECKPOINT_DIR=$TRANS/checkpoint_en2xh_7
CUDA_VISIBLE_DEVICES=1 fairseq-train \
        data-bin-en2xh/baseline-tokenized.en-xh \
